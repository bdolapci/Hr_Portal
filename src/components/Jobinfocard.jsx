...
function Jobcard(props) {
  ...
  return (
    ...
    <Card sx={{ display: 'flex',width:"50rem",alignItems:"center",height:"11rem" }}>
    <Button onClick={jobInfo} variant='contained' style={{height:"50px", width:"9rem", marginLeft:"30px"}}>Apply Job</Button>
     ...
     {props.photo=="" ? <img src={banner} style={{maxWidth:"250px",borderRadius:"1.125rem"}} alt="empty"/> :
        <img style={{maxWidth:"250px",maxHeight:"150px"}} src={"https://hrportal.blob.core.windows.net/uploadfile/"+props.photo} alt="banner"></img>}  
     </Box>
    </Card>
    </>
  )
