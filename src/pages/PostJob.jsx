  ...
  const uploadFile = async (event) => {
    ...
    try {
      const res = await axios.post(
        "https://localhost:44361/api/Home/UploadFile",
        formData
      );
      console.log(res);
      setAlert1(true);
  ...
  const postJob = async () => {
    try {
      if (fileName == undefined) {
        const res = await axios.post("https://localhost:44361/api/Home/Jobs", {
          UserId: decoded.id,
          Name: `${name}`,
          Date: `${value}`,
              ...
              >
                <div className="contain" style={{ display: "flex" }}>
                  ...
                  >
                    ...
                    ></TextField>
                    <Box
                      sx={{ marginTop: "0", marginBottom: "2%", width: "40%" }}
                    >
                    ...
                    <Box
                      sx={{ width: "100%", marginBottom: "2%", marginTop: "0" }}
                    >
                    ...
                    <Typography>Pick a photo</Typography>
                    <div
